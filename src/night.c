...
static void night_env_get_runtime (void) {
...
static unsigned int night_env_get_port (void) {
...
static void night_env_get_cerver_receive_buffer_size (void) {
...
static void night_env_get_cerver_th_threads (void) {
...
static void night_env_get_cerver_connection_queue (void) {
...
static unsigned int night_init_env (void) {

	unsigned int errors = 0;

	night_env_get_runtime ();

	errors |= night_env_get_port ();

	night_env_get_cerver_receive_buffer_size ();

	night_env_get_cerver_th_threads ();

	night_env_get_cerver_connection_queue ();
...
unsigned int night_init (void) {

	unsigned int errors = 0;

	if (!night_init_env ()) {
		errors |= night_service_init ();
	}
